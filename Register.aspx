...
<body>
    ...
    <div>
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td>Password<asp:TextBox ID="TextBox2" class="box" runat="server"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
        </table>
        ...
        <colspan=4><asp:Button ID="Button1" runat="server" class="submit"  OnClick="Button1_Click" Text="Register" />
