...
<body>
    <form id="form1" runat="server" class="form">
        ...
        <table class="auto-style1">
             <th colspan=2><marquee><h2>!! STUDENT DETAILS!!</h2></marquee></th>
            <tr>
                <td>Student ID<asp:TextBox ID="TextBox1" class="box" runat="server"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Parent ID<asp:TextBox ID="TextBox7" class="box" runat="server"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td>Date Of Join<asp:TextBox ID="TextBox8" class="box" runat="server"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td>Status<asp:TextBox ID="TextBox9" class="box" runat="server"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
        </table>
        ...
        <asp:LinkButton ID="LinkButton1" runat="server" class="submit" PostBackUrl="~/RptStudent.aspx">Report</asp:LinkButton>
        <asp:GridView ID="GridView1" runat="server" Height="276px" Width="597px" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2">
            <Columns>
