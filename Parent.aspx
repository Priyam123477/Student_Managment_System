...
<body>
    <form id="form1" runat="server" class="form">
        ...
        <table class="auto-style1">
            <th colspan=2><marquee><h2>!! PARENT!!</h2></marquee></th>
            <tr>
                <td>Parent ID<asp:TextBox ID="TextBox1" class="box" runat="server"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
        ...
        <asp:LinkButton ID="LinkButton1" runat="server" class="submit" PostBackUrl="~/RptParent.aspx">Report</asp:LinkButton>
        <asp:Button ID="Button6" runat="server" Text="Psearch" OnClick="Button6_Click" class="submit"/>
        <asp:GridView ID="GridView1" runat="server" Height="284px" Width="609px" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None">
